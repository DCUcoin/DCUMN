...
This document describes the protocol extensions for all additional functionality build into the DCU protocol. This doesn't include any of the DCU protocol, which has been left intact in the DCU project. For more information about the core protocol, please see https://en.dcu.it/w/index.php?title#Protocol_documentation&action#edit
...
DCU Outpoint https://dcu.org/en/glossary/outpoint
...
DCU Input https://dcu.org/en/glossary/input
...
DCU Output https://dcu.org/en/glossary/output
...
DCU Public Key https://dcu.org/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 1000 DCU
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 1000 DCU unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 dcu)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the dcu treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 1000 DCU for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 1000 DCU for masternode 2
