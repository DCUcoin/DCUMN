...
unlocked to sign the DCU-Qt.app bundle.
...
allowing somebody to distribute a DCU-Qt.app or dcu-qt-setup.exe with a valid
...
that the dcu-qt.exe file inside the installer had not been tampered with.
