...
This mechanism has been integrated into Bitcore-Node-DCU which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dcucrypto/insight-api-dcu#web-socket-api](https://github.com/dcucrypto/insight-api-dcu#web-socket-api)
* API: [https://github.com/dcucrypto/insight-api-dcu#instantsend-transactions](https://github.com/dcucrypto/insight-api-dcu#instantsend-transactions)
...
By default, the DCU Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DCU Core daemon:
