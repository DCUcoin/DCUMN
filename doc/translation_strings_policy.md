...
This document provides guidelines for internationalization of the DCU Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dcu_en.ts` remains unchanged.
