...
DCU Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- DCUMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as DCU Core, where everyone uses
...
pay attention to for reviewers of DCU Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: DCU Core uses tinyformat, which is type safe. Leave them out to avoid confusion
