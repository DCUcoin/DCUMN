...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || dataDirDefaultCurrent != dataDirDefaultSettings)
    {
        ...
        intro.setWindowIcon(QIcon(":icons/dcu"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DCU Core"),
     ...
     * override -datadir in the dcu.conf file in the default data directory
     * (to be consistent with dcud behavior)
     */
