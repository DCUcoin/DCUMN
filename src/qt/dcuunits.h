...
#ifndef DCU_QT_DCUUNITS_H
#define DCU_QT_DCUUNITS_H
...
/** DCU unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DCUUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DCUUnits(QObject *parent);

    /** DCU units.
      @note Source: https://en.dcu.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DCU,
...
typedef DCUUnits::Unit DCUUnit;

#endif // DCU_QT_DCUUNITS_H
