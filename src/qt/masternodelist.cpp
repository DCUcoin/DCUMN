...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, const COutPoint& outpoint)
{
    ...
    QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(fFound ? CDCUAddress(infoMn.pubKeyCollateralAddress.GetID()).ToString() : ""));
...
void MasternodeList::updateNodeList()
{
    ...
    for(auto& mnpair : mapMasternodes)
    {
        ...
        QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(CDCUAddress(mn.pubKeyCollateralAddress.GetID()).ToString()));
