    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DCU-light"), QVariant("light"));
    ui->theme->addItem(QString("DCU-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("DCU-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DCU-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DCU-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new DCUUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->dcuAtStartup, OptionsModel::StartAtStartup);
