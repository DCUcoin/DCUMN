...
#include "config/dcu-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatDCUURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + DCUUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatDCUURI(info));
}
