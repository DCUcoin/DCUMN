...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(DCUUnits::DCU),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = DCUUnits::floorWithUnit(unit, amount, true, DCUUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, DCUUnits::separatorAlways));
    ui->labelUnconfirmed->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, DCUUnits::separatorAlways));
    ui->labelImmature->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, DCUUnits::separatorAlways));
    ui->labelAnonymized->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, DCUUnits::separatorAlways));
    ui->labelTotal->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, DCUUnits::separatorAlways));
    ui->labelWatchAvailable->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, DCUUnits::separatorAlways));
    ui->labelWatchPending->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, DCUUnits::separatorAlways));
    ui->labelWatchImmature->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, DCUUnits::separatorAlways));
    ui->labelWatchTotal->setText(DCUUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, DCUUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("DCU")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = DCUUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, DCUUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), DCUUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = DCUUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, DCUUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), DCUUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(DCUUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(DCUUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
