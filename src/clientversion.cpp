 ...
 * for both dcud and dcu-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("DCU Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/dcu/bips/blob/master/bip-0014.mediawiki) 
 */
