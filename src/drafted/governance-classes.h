 ...
 *
 *   // network
 *   CDCUNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.dcu.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDCUNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: DCUNetwork
// //   -- signature requirements : Key1(User)
// class CDCUNetworkVariable : public CGovernanceObject
// {
// private:
