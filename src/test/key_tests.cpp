...
static const CDCUAddress addr1 ("Xywgfc872nn5CKtpATCoAjZCc4v96pJczy");
static const CDCUAddress addr2 ("XpmouUj9KKJ99ZuU331ZS1KqsboeFnLGgK");
static const CDCUAddress addr1C("XxV9h4Xmv6Pup8tVAQmH97K6grzvDwMG9F");
static const CDCUAddress addr2C("Xn7ZrYdExuk79Dm7CJCw7sfUWi2qWJSbRy");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CDCUAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CDCUSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
