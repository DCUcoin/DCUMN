...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CDCUAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CDCUAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CDCUAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CDCUAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CDCUAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CDCUAddress(arr[0].get_str()).Get() == demoAddress.Get());
