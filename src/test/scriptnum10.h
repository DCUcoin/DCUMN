...
#ifndef DCU_TEST_SCRIPTNUM10_H
#define DCU_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from DCU Core 0.10.0, for cross-comparison.
 */
public:
