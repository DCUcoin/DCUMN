...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1 * 60; // DCU: 1 hour
        consensus.nPowTargetSpacing = 1 * 60; // DCU: 1 minutes
        ...
        nDefaultPort = 12013;
        nMaxTipAge = 6 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in dcu
   ...
   /*
     ...
     */
        ...
        vSeeds.push_back(CDNSSeedData("dcu.hosthampster.com", "dcu.hosthampster.com"));
        vSeeds.push_back(CDNSSeedData("dcu1.hosthampster.com", "dcu1.hosthampster.com"));
        ...
        // DCU addresses start with 'D'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        // DCU script addresses start with '8'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,18);
        // DCU private keys start with 't'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128+63);
        // DCU BIP32 pubkeys start with 'xpub' (DCU defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // DCU BIP32 prvkeys start with 'xprv' (DCU defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // DCU BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 30 * 60 * 2; // DCU: 1 hour
        consensus.nPowTargetSpacing = 2 * 60; // DCU: 2 minutes
       ...
       // assert(consensus.hashGenesisBlock == uint256S("0x00000ba049e5c1f95474ea3fc62d5f1b1632a294c20c22fea701134a43cf3068"));
        ...
        vSeeds.push_back(CDNSSeedData("testnet.dcuproject.org", "testnet.seed.dcuproject.org"));
        vSeeds.push_back(CDNSSeedData("fixed-seeds.dcuproject.org", "testnet.fixed-seeds.dcuproject.org"));
        // vFixedSeeds.clear();
        // vSeeds.clear();

        // Testnet DCU addresses start with 'm'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,110);
        // Testnet DCU script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,21);
        // Testnet private keys start with '9' or 'c' (DCU defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet DCU BIP32 pubkeys start with 'tpub' (DCU defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet DCU BIP32 prvkeys start with 'tprv' (DCU defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet DCU BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
       ...
       // assert(consensus.hashGenesisBlock == uint256S("0x000005ec6d48ac579d697448a82e93127b94403770629399cf561caa216a694b"));
        ...
        // Regtest DCU addresses start with 'o'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,115);
        // Regtest DCU script addresses start with 'a'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,83);
        // Regtest private keys start with '9' or 'c' (DCU defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest DCU BIP32 pubkeys start with 'tpub' (DCU defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest DCU BIP32 prvkeys start with 'tprv' (DCU defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest DCU BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
