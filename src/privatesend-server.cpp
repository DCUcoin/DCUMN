...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all DCU related functionality
...
/*
    ...
    allow endless transaction that would bloat DCU and make it unusable. To
